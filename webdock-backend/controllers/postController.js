...
const { fetchExternalData } = require("../utility/fetchExternalData");
...
const createNewPost = async (req, res) => {
    ...
    // send data to webdock, fetch moved to utility folder for reusability
    const responseData = await fetchExternalData(externalEndpoint, externalData);
